...
@Directive({
  selector: 'button[uk2SecondaryIconButton][mat-stroked-button][disableRipple]:not([color])',
})
export class Uk2SecondaryIconButtonDirective
  extends ButtonAbstractDirective
  implements OnInit, OnChanges, IUk2IsLoading
{
  ...
  constructor(el: ElementRef<HTMLButtonElement>) {
    super(
      el,
      'uk2-secondary-icon-button-small',
      'uk2-secondary-icon-button-medium',
      'uk2-secondary-icon-button-large',
