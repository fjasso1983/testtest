...
### Basic Usage
  <p>
  This is an example on how to achieve integration for multiples usage of single options selector card.
  </p>
  <ul>
    <li>
...
<Source
  ...
  <p>
    Options selected:
    <span *ngFor="let value of multipleOption.selectedOptions.selected">{{ value }}</span>
  </p>
  `}
/>
<br/>
...
### Reactive Form Integration
  <p>
  This is an example on how to achieve integration of multiples options selector card with Reactive Form.
  </p>
...
### Template Driven Form Integration
  <p>
  This is an example on how to achieve integration of multiples options selector card with Template Driven Form.
  </p>
  ...
  code={dedent`
      <form #myForm="ngForm" (ngSubmit)="onTemplateDrivenFormSubmit()">
        <mat-selection-list
          ...
          [uk2IsLoading]="isLoading"
          required
          name="multipleSelectedAddress"
          #multipleSelectedAddress
          [(ngModel)]="user.multipleSelectedAddress"
        >
          <mat-list-option *ngFor="let address of addresses; index as i" [value]="address">
            <div class="uk2-checkbox-selection-cards-icon-container">
              <mat-icon  class="uk2-icon-tier-1"  [svgIcon]="'uk2-location-pin'"></mat-icon>
