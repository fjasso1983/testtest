...
import chevronDocumentation from './checkbox-basic-usage.docs.mdx';
import { HttpClientModule } from '@angular/common/http';
import { StoriesCommonModule } from 'stories/stories-common.module';

export default {
  title: 'Components/Selector Cards/Multiple Option',
...
} as unknown as Meta<CheckboxBasicUsageComponent>;

const basicUsageTemplate: Story<CheckboxBasicUsageComponent> = (args: CheckboxBasicUsageComponent) => ({
  component: CheckboxBasicUsageComponent,
  props: {
    ...args,
  },
